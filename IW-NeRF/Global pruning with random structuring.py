...
i=0.9
prune.random_structured(model.block1_1[0], 'weight',amount=i , dim=0)
prune.random_structured(model.block1_2[0], 'weight',amount=i , dim=0)
prune.random_structured(model.block1_3[0], 'weight',amount=i ,dim=0)
prune.random_structured(model.block1_4[0], 'weight',amount=i , dim=0)
prune.random_structured(model.block1_5[0], 'weight',amount=i , dim=0)
prune.random_structured(model.block1_6[0], 'weight',amount=i , dim=0)
prune.random_structured(model.block1_7[0], 'weight',amount=i , dim=0)
prune.random_structured(model.block1_8[0], 'weight',amount=i ,dim=0)
prune.random_structured(model.block2_1[0], 'weight',amount=i , dim=0)
prune.random_structured(model.block2_2[0], 'weight',amount=i , dim=0)
prune.random_structured(model.block2_3[0], 'weight',amount=i , dim=0)
prune.random_structured(model.block2_4[0], 'weight',amount=i , dim=0)
prune.random_structured(model.block2_5[0], 'weight',amount=i , dim=0)
prune.random_structured(model.block2_6[0], 'weight',amount=i , dim=0)
prune.random_structured(model.block2_7[0], 'weight',amount=i , dim=0)
prune.random_structured(model.block2_8[0], 'weight',amount=i , dim=0)
prune.random_structured(model.block3_1[0], 'weight',amount=i , dim=0)
prune.random_structured(model.block3_2[0], 'weight',amount=i , dim=0)
prune.random_structured(model.block3_3[0], 'weight',amount=i ,dim=0)
prune.random_structured(model.block4_1[0], 'weight',amount=i , dim=0)
prune.random_structured(model.block4_2[0], 'weight',amount=i , dim=0)
prune.random_structured(model.block4_3[0], 'weight',amount=i , dim=0)


prune.remove(model.block1_1[0], 'weight')
prune.remove(model.block1_2[0], 'weight')
prune.remove(model.block1_3[0], 'weight')
prune.remove(model.block1_4[0], 'weight')
